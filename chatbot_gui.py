...
class ChatBot:
    ...
    def add_train(self):
        ...
        head_label=Label(self.train_frame,bg=BG_COLOR,fg=TEXT_COLOR,text="Make Bot",font=FONT_BOLD,pady=10)
        head_label.place(relwidth=1)
        ...
        train_button=Button(bottom_label,text="Train Bot",font=FONT_BOLD,width=12,bg="Gray",command=lambda: self.on_train(None))
    ...
    def on_train(self,event):
        ...
        with open('intents1.json','r+') as json_file:
